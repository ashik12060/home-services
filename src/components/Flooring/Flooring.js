...
import roofImg from "../../images/flooringScreenshot.png";
...
const Flooring = () => {
  const benefits = [
    {
      icon: investIcon,
      title: "Invest in Lasting Premium Quality.",
      description:
        "Investing in quality flooring is an investment in the long-term durability and aesthetics of your space, providing lasting value and satisfaction.",
    },
    {
      icon: tempIcon,
      title: "Repairs Boost Appeal, Ensure Longevity.",
      description:
        "Efficient repairs not only restore the beauty of your floors but also contribute to the longevity of your investment, ensuring a space that continues to impress.",
    },
    {
      icon: increaseIcon,
      title: "Increase Property Value with Strategic Upgrades",
      description:
        "It can significantly increase the market value of your property, whether you are looking to sell or simply enhance your living or working environment.",
    },
  ];
  ...
  return (
    <>
      ...
      <section className="relative bg-gradient-to-r from-green-50 via-white to-green-50 py-12 overflow-hidden">
       ...
       Discover the perfect flooring for your home or business with our expert flooring services. We specialize in providing high-quality, stylish, and durable flooring options that cater to your unique needs. Trust us to deliver a seamless and budget-friendly transformation, enhancing the aesthetic appeal and functionality of your space without compromising on quality.
            </p>
            <strong>
Step Into Elegance: Tailored Flooring Solutions for Your Unique Style!        </strong>
            <p className="text-base text-gray-800 leading-snug">
      Elevate your space with our expert flooring services, offering tailored solutions to complement your unique style. Our commitment to a seamless process ensures a budget-friendly transformation, bringing beauty and durability to your floors. <br/> <br/><span className="font-semibold">Trust us to fortify your home with dependable and budget-friendly flooring services.</span>
            </p>
