...
import roofImg from "../../images/winddowsScreenshot.png";
...
const Window = () => {
  const benefits = [
    {
      icon: investIcon,
      title: "Invest in Home with New Windows!",
      description:
        "Boost comfort, energy efficiency, and property value with new windows—an investment that enhances both aesthetics and functionality.",
    },
    {
      icon: tempIcon,
      title: "Return to a Safe, Cozy Home",
      description:
        "Experience the reassurance of safety, the warmth of coziness, and the comforting embrace of a welcoming home when you return.",
    },
    {
      icon: increaseIcon,
      title: "Add Value and Appeal to Your Investment!",
      description:
        "Enhance the desirability and financial worth of your property by investing in upgrades that bring both lasting value and irresistible charm.",
    },
  ];
  ...
  return (
    ...
    Unlock savings on all your window installation needs with our expert services. Trust us to provide cost-effective solutions without compromising on quality, ensuring a seamless and budget-friendly upgrade for your home.
            </p>
            <strong>
Windows that Transform: Beauty, Efficiency, and Savings – All in One Service!       
</strong>
            <p className="text-base text-gray-800 leading-snug">
    Elevate your home with our premier window service, seamlessly blending beauty and efficiency. Our expert touch ensures a transformative experience, enhancing your living space while offering cost-effective solutions. <br/> <br/><span className="font-semibold">Efficiently managing background tasks and processes on the Windows platform with a reliable and seamless window service.</span>
            </p>

            {/* ✅ Services List with Green Check */}
            <ul className="space-y-2">
              {[
                "Effortless Elegance for Your Home",
      ...
      <section className="bg-gray-50 py-16">
        <div className="container mx-auto px-6 lg:px-12 text-center lg:text-left">
         ...
         Experience heightened energy efficiency, enhanced aesthetics, and increased property value with our comprehensive window installation, repair, and upgrade services.
Upgrade windows for enhanced aesthetics and energy efficiency, reducing heating and cooling costs.
          </p>
