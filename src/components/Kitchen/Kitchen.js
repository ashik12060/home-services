...
import roofImg from "../../images/kitchenScreenshot.png";
...
const Kitchen = () => {
  const benefits = [
    {
      icon: investIcon,
      title: "Invest in Your Culinary Lifestyle",
      description:
        "Investing in your kitchen is an investment in your culinary lifestyle. A well-designed and efficiently organized space enhances your cooking experience, making everyday tasks a pleasure.",
    },
    {
      icon: tempIcon,
      title: "Efficient Repairs for Long-Term Satisfaction",
      description:
        "Efficient repairs not only restore the functionality of your kitchen but also contribute to the long-term satisfaction of your investment, ensuring a space that continues to meet your culinary needs.",
    },
    {
      icon: increaseIcon,
      title: "Increase Home Value with Strategic Upgrades",
      description:
        "Strategic kitchen upgrades can significantly enhance the market value of your home, offering both modern aesthetics and improved functionality for potential buyers or long-term enjoyment.",
    },
  ];
  ...
  return (
    ...
    The kitchen is the heart of every home. Whether you're looking for a sleek modern upgrade or a cozy traditional feel, our expert service providers bring your vision to life with high-quality craftsmanship and exceptional expertise.Count on us to assist you in saving on all your kitchen needs. 
    <br />From repairs to installations, our cost-effective solutions guarantee quality without compromising your budget.
Trust us to enhance your home with reliable and affordable kitchen services.
            </p>
            <strong>
Culinary Excellence at Your Fingertips: Tailored Kitchen Services for Your Home!</strong>
            <p className="text-base text-gray-800 leading-snug">
    Indulge in the ultimate kitchen experience with our expert home services, offering tailored solutions to meet your unique culinary preferences. Our commitment to excellence guarantees a budget-friendly transformation, bringing beauty and functionality to one of the most important spaces in your home. <br/> <br/><span className="font-semibold">Rely on us to elevate the durability and longevity of your kitchen while maintaining costs within reach.</span>
            </p>

            {/* ✅ Services List with Green Check */}
            <ul className="space-y-2">
              {[
                "Tailored Kitchen Services.",
                "Budget-Friendly Transformations.",
                "Expert Home Services.",
                "Culinary Excellence for Your Kitchen.",
              ].map((item, idx) => (
                <li
                  key={idx}
      ...
      <section className="bg-gray-50 py-16">
        <div className="container mx-auto px-6 lg:px-12 text-center lg:text-left">
         ...
         Kitchen renovations ensure structural functionality and provide protection against wear and tear. Routine maintenance prevents extensive damage, while upgrades enhance energy efficiency and elevate the overall value of your property.
Together, these services contribute to the safety, longevity, and aesthetics of your kitchen space.
          </p>
              ...
              >
                ...
                >
                  <h4 style={{ color: "white" }}>
                    <span className="steps-qtd">Kitchen</span> Quotes
                  </h4>
                  <div
