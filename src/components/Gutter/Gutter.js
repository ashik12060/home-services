...
import roofImg from "../../images/gutterScreenshot.png";
...
import GutterHero from "./GutterHero";

const Gutter = () => {
  const benefits = [
    {
      icon: investIcon,
      title: "Preserve Your Home's Foundation",
      description:
        "Properly functioning gutters are essential in preserving your home's foundation by directing water away from its base. Avoid costly foundation repairs by investing in reliable gutter solutions.",
    },
    {
      icon: tempIcon,
      title: "Prevent Water Damage to Your Property",
      description:
        "Protect your home from water damage, including basement flooding, mold growth, and erosion of landscaping. Our gutter services ensure efficient water diversion, safeguarding your property.",
    },
    {
      icon: increaseIcon,
      title: "Extend the Lifespan of Your Exterior",
      description:
        "By preventing water from pooling around your home, our gutter solutions contribute to the longevity of your exterior materials, such as siding, paint, and landscaping features.",
    },
  ];
      ...
      <section className="relative bg-gradient-to-r from-green-50 via-white to-green-50 py-12 overflow-hidden">
        <div className="container mx-auto px-6 lg:px-12 flex flex-col-reverse lg:flex-row items-center gap-10">
          ...
          <div className="flex-1 space-y-4">
            ...
            Rely on us to assist you in saving on all your gutter needs. From repairs to installations, our cost-effective solutions guarantee quality without compromising your budget.
Trust us to safeguard your home with reliable and affordable gutter services.
            </p>
            <strong>
Defend Your Home: Tailored Gutter Solutions for Maximum Protection!            </strong>
            <p className="text-base text-gray-800 leading-snug">
             Fortify your home with our expert gutter services, offering tailored solutions to meet your specific needs. Our commitment to excellence guarantees a budget-friendly transformation, providing you with peace of mind and protection against the damaging effects of water runoff.
            </p>

            {/* ✅ Services List with Green Check */}
            <ul className="space-y-2">
              {[
                "Tailored Gutter Solutions.",
                "Budget-Friendly Transformations.",
                "Expert Gutter Services.",
                "Maximum Home Defense.",
              ].map((item, idx) => (
                <li
                  key={idx}
      ...
      <section className="bg-gray-50 py-16">
        <div className="container mx-auto px-6 lg:px-12 text-center lg:text-left">
          ...
          <p className="text-gray-700 text-base mb-10 max-w-3xl mx-auto lg:mx-0">
            Gutter services play a crucial role in maintaining the structural integrity of your home and preventing potential issues associated with water damage.
Trust us to extend the durability and longevity of your gutters, all while keeping costs within your reach.
          </p>
