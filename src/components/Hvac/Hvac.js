...
import roofImg from "../../images/hvacScreenshot.png";
...
const Hvac = () => {
  const benefits = [
    {
      icon: investIcon,
      title: "Elevate HVAC System Efficiency.",
      description:
        "Maximize your HVAC investment with our tailored solutions for sustainable energy. From precision installations to personalized upgrades, we ensure the longevity and resilience of your system.",
    },
    {
      icon: tempIcon,
      title: "Energy-Efficient Repairs for Savings",
      description:
        "Reduce bills, qualify for incentives with timely HVAC maintenance. Expert repairs significantly extend the system lifespan, making your home smarter and more cost-effective in the long run.",
    },
    {
      icon: increaseIcon,
      title: "Elevate Value: Green HVAC Upgrades.",
      description:
        "Invest wisely in sustainable upgrades that not only enhance your living space but also give your property a competitive edge in the real estate market for a greener and more valuable future.",
    },
  ];
  ...
  return (
    ...
    Unlock comfort and energy efficiency with our professional HVAC services. Trust us to provide cost-effective solutions for all your heating, ventilation, and air conditioning needs. We ensure a seamless and budget-friendly transition to a climate-controlled home or business without compromising on quality.
            </p>
            <strong>
Experience Ultimate Comfort: Tailored HVAC Solutions for You!      
</strong>
            <p className="text-base text-gray-800 leading-snug">
    Elevate your indoor comfort with our expert HVAC services, delivering tailored solutions to meet your unique needs. Our seamless approach ensures a budget-friendly transition to optimal climate control without sacrificing quality. <br/> <br/><span className="font-semibold">Rely on us to optimize the durability and lifespan of your HVAC system, all while maintaining cost-effectiveness.</span>
            </p>
      ...
      <section className="bg-gray-50 py-16">
        ...
        HVAC installation, repair, and upgrades not only enhance indoor comfort but also contribute to energy savings and improve the overall efficiency of your home or business environment.
          </p>
              ...
              >
                ...
                >
                  <h4 style={{ color: "white" }}>
                    <span className="steps-qtd">Hvac </span> Quotes
                  </h4>
                  <div
