...
import roofImg from "../../images/sidingScreenshot.png";
...
import SidingHero from "./SidingHero";

const Siding = () => {
  const benefits = [
    {
      icon: investIcon,
      title: "Protect Your Home from the Elements",
      description:
        "Quality siding acts as a shield, protecting your home from harsh weather conditions, moisture, and pests. Our siding solutions ensure durability and resilience against the elements.",
    },
    {
      icon: tempIcon,
      title: "Enhance Energy Efficiency",
      description:
        "Well-installed siding contributes to improved insulation, increasing the energy efficiency of your home. Enjoy a comfortable interior while reducing energy bills with our expert siding services.",
    },
    {
      icon: increaseIcon,
      title: "Elevate Curb Appeal Excellence",
      description:
        "Transform the look of your home with stylish siding options that complement your architectural style. Our siding services enhance curb appeal, making a lasting impression on visitors and passersby.",
    },
  ];
  ...
  return (
   ...
   Enhance the curb appeal, durability, and energy efficiency of your home with our expert siding services. We specialize in delivering high-quality, tailored solutions that protect and beautify your property. Trust us to provide seamless and budget-friendly services, ensuring your home's exterior stands the test of time with style and resilience.
    <br />
            </p>
            <strong>
Transform Your Home: Tailored Siding Solutions for Beauty and Durability!</strong>
            <p className="text-base text-gray-800 leading-snug">
    Renew your home with our expert siding services, offering tailored solutions to meet your specific needs. Our commitment to excellence guarantees a budget-friendly transformation, providing you with a stunning and resilient exterior that complements your lifestyle. <br/> <br/><span className="font-semibold">Trust us to improve the durability and longevity of your siding while maintaining affordability.</span>
            </p>

            {/* ✅ Services List with Green Check */}
            <ul className="space-y-2">
              {[
                "Tailored Siding Solutions.",
      ...
      <section className="bg-gray-50 py-16">
        <div className="container mx-auto px-6 lg:px-12 text-center lg:text-left">
         ...
         Siding services not only enhance the aesthetic appeal of your home but also contribute to its protection, energy efficiency, and overall longevity.
Collectively, these services contribute to the safety, durability, and aesthetics of your building's siding.
          </p>
              ...
              >
                ...
                >
                  <h4 style={{ color: "white" }}>
                    <span className="steps-qtd">Siding </span> Quotes
                  </h4>
                  <div
                  ...
                  >
                    <div className="d-flex align-items-center justify-content-center mb-3">
                      ...
                      <div>
                        ...
                        >
                          <span className="steps-qtd">Siding</span>{" "}
                          Service Provider
                        </p>
                      </div>
                    </div>
