...
const SolarHero = () => {
    ...
    useEffect(() => {
        ...
        form.lead_id.value = `PLUMB-${Date.now()}-${Math.floor(Math.random() * 100000)}`;
    ...
    return (
        <section
            className="relative bg-cover bg-center bg-no-repeat pt-8 md:pt-12 pb-20"
        ...
        >
            ...
            <div className="relative container mx-auto px-6 md:px-10 grid md:grid-cols-2 gap-10 md:gap-16 items-start">
                {/* Left Content */}
                <div className=" space-y-6 mt-4 md:mt-8 text-blue-900">
                    <div className="flex flex-wrap items-center gap-3">
                        <img src={star} alt="Star" className="w-20 md:w-24" />
                        <p className="text-lg md:text-xl font-medium">
                            Helped <span className="font-bold text-orange-500">22,400+</span> Customers Find Top Contractors
                        </p>
                        <img src={bnr_rev_people} alt="People" className="w-20 md:w-24" />
                    </div>

                    <h1 className="text-4xl md:text-5xl font-extrabold leading-tight drop-shadow-lg text-blue-900">
                        Find & Hire
                        The Best Solar <br />
                        Experts in No Time!
                    ...
                    <div className="flex items-center gap-3 bg-white/10 backdrop-blur-sm p-3 rounded-xl w-fit">
                        ...
                        <p className="text-sm md:text-base">
                            Your information is <span className="font-semibold text-blue-700">100% secure</span> & confidential.
                        </p>
                    </div>

                    <button
                        onClick={() => document.getElementById("top_form")?.scrollIntoView({ behavior: "smooth" })}
