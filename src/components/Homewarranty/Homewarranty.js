...
import roofImg from "../../images/homewarrantyScreenshot.png";
...
import HomewarrantyHero from "./HomewarrantyHero";

const Homewarranty = () => {
  const benefits = [
    {
      icon: investIcon,
      title: "Investment ProtectionInvestment Protection",
      description:
        "Our home warranty service strengthens protection, ensuring enduring efficacy. Meticulous repairs and enhancements add a layer of security, providing peace of mind for your valuable investment.",
    },
    {
      icon: tempIcon,
      title: "Privacy Elevated",
      description:
        "Security measures guarantee a private and secure space for your family. Our home warranty service enhances, maintains, or upgrades home security systems, creating a safe haven for your loved ones.",
    },
    {
      icon: increaseIcon,
      title: "Elegant Security Solutions",
      description:
        "Experience an inviting atmosphere with our stylish security solutions. Our home warranty service includes maintenance, repairs, and upgrades, enhancing home security and curb appeal.",
    },
  ];
          ...
          <div className="flex-1 space-y-4">
            <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 leading-snug">
             We Help You Save On All
              ...
              Your Home Warranty Installation
              </span>
            </h2>

            <p className="text-gray-700 text-base leading-snug">
    Elevate your peace of mind with our cost-effective home warranty services, meticulously designed for comprehensive protection. Our customized solutions encompass surveillance, access control, and maintenance, creating a fortified shield for your home or business.
    <br />
            </p>
            <strong>
Elevate your security with our customized solutions!</strong>
            <p className="text-base text-gray-800 leading-snug">
    Elevate your home protection with our top-tier home warranty services, crafted by experts to cater to your unique needs. Our integrated solutions guarantee a smooth and cost-effective transition to a more secure environment, all while maintaining the highest standards of quality. <br/> <br/><span className="font-semibold">Safeguard your home effortlessly with our customized home warranty services, providing you peace of mind and comprehensive coverage for unforeseen repairs and replacements.</span>
            </p>
            ...
            <ul className="space-y-2">
              {[
                ...
                "Budget-Friendly Home Protection.",
                "Professional Home Warranty Services.",
      ...
      <section className="bg-gray-50 py-16">
        <div className="container mx-auto px-6 lg:px-12 text-center lg:text-left">
         ...
         Our home warranty services extend beyond basic protection, providing you with a comprehensive range of options to enhance the safety and security of your home or business. We also contribute to energy savings, ensuring a more efficient living or working environment. Trust in our commitment to excellence for a worry-free experience.
